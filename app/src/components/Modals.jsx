...
export default function Modals({ openModal, modalFunctions, gameID, status, closeModal }) {
  ...
  return (
    <>
        ...
        {MODALS.GAMEOVER === openModal && <GameOverModal status={status} toggleCreateGame={() => toggleOption("createGame")} closeModal={closeModal} />}
